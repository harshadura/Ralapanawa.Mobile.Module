		...
		btLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(getApplicationContext(),
						"Welcome to Ralapanawa Mobile!", Toast.LENGTH_LONG)
						.show();
			}
		});

		new ServiceHelper().checkin(Login.this);
		
		ProjectSettingsHandler handler=new ProjectSettingsHandler(Login.this);
	}
